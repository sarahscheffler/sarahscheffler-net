...
%
%\vspace{0.1in}
%Improving accountability in non-transparent systems by combining methods in cryptography, multi-party computation, and
...
%\item[\eeepolicy] S.~Scheffler. \\
%\emph{A U.S. Policy Proposal for Preventing Scope Creep in End-to-End Encrypted Content Moderation.} \\
...
%\textbf{Titanoboa Intro to Programming:} Planned for Spring of 2021, proposed and co-organized a
%course covering an introduction to Python as well as several other computing-related topics, aimed
%at teaching students of races underrepresented in STEM. \\
...
%    {\bf Efficient Blacklists for E2E Encrypted Messaging} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU \>~~~~~~~~~~~~~~~~~~~~~~~~~~Sep.  2018 - Present\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%   Ongoing research with Prof.~Mayank Varia and students, 
%   using Private Set Intersection and Searchable Encryption methods to create a method for using a
%   server-side blacklist to allow a receiving client to flag banned messages in end-to-end
%   encrypted chat, in an efficient manner that maintains small ciphertext size and sufficiently low
%   delivery time.
%
%   \begin{tabbing}
%   \hspace{3in}\=  \hspace{1.63in}\= \kill % set up two tab positions
%    {\bf Protecting Cryptography from Self-Incrimination} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU
%    \>~~~~~~~~~~~~~~~~~~~~~~~~~~Jan. 2019 - Present\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%   Ongoing research with Prof.~Mayank Varia, 
%   technical analysis of the current state of affairs with regard to whether various cryptographic
%   constructs can be compelled in a government subpoena as a ``foregone conclusion'' exception to
%   the U.S. 5th Amendment right against self-incrimination.
%
%
%   \begin{tabbing}
%   \hspace{3in}\=  \hspace{1.63in}\= \kill % set up two tab positions
%    {\bf Legality of Lethal Autonomous Weapons} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU
%    \>~~~~~~~~~~~~~~~~~~~~~~~Jan. 2018 - Oct. 2019\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%    In a partnership with a law student, corrected false assumptions in the ongoing debate over
%    whether to ban or otherwise regulate fully autonomous weapons systems, and analyzing how their
%    ``predictability'' influences their legality under the Law of Armed Conflict.
%    Won 2nd place in the ACM CSLaw Student Paper Competition.
%
%   \begin{tabbing}
%   \hspace{3in}\=  \hspace{1.63in}\= \kill % set up two tab positions
%    {\bf Fairly Post-Processing Calibrated Classifiers} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU \>~~~~~~~~~~~~~~~~~~~~~~~Jan.  2018 - Jan. 2019\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%   Ongoing research with Prof.~Ran Canetti and Prof.~Adam Smith, seeking to analyze the algorithmic fairness properties
%   that can be achieved when post-processing a non-binary classifier that is calibrated into a
%   binary decision.  \fairsibility
%
%   \begin{tabbing}
%   \hspace{3in}\=  \hspace{1.63in}\= \kill % set up two tab positions
%    {\bf Privacy Policy Disclosure of Device Fingerprinting} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU
%    \>~~~~~~~~~~~~~~~~~~~~~~Dec. 2018 - Jun. 2019\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%   Joint work with Prof.~Mayank Varia, Prof.~Ari Trachtenberg, Prof.~Andrew Sellars, Prof.~Julissa
%   Milligan, and Trishita Tiwari.
%    An investigation into major websites' disclosure methods for Canvas fingerprinting and a
%    dichotomy of fingerprinting practices into ``direct'' and ``indirect,'' with predictions for
%    the future of privacy on the web. \devicefingerprinting
%
%   \begin{tabbing}
%   \hspace{3in}\=  \hspace{1.63in}\= \kill % set up two tab positions
%    {\bf Failure-Resistant Ensemble PBKDF} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU \>~~~~~~~~~~~~~~~~~~~~~~~~~~Jan. 2017 - Present\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%   Ongoing research with Prof.~Mayank Varia and Dr.~Jason Hennessey,
%    proposing a new approach to Password-Based key Derivation Functions
%    (PBKDFs) that has
%    failure-resistance, is optimized
%    for specific platforms, and resistance to pipelining and
%    parallelism.
%
%   \begin{tabbing}
%   \hspace{3in}\=  \hspace{1.63in}\= \kill % set up two tab positions
%    {\bf DNS Vulnerabilities through Email} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU
%    \>~~~~~~~~~~~~~~~~~~~~~~~Jan. 2017 - Jan. 2018\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%   Ongoing research with a group of students advised by Prof. Sharon Goldberg,
%    use spam prevention techniques like SPF and DKIM to exploit vulnerabilities in the Domain Name System to cause denial of service attacks or DNS cache poisoning.
%    \emailspam
%
%   \begin{tabbing}
%   \hspace{3in}\=  \hspace{1.63in}\= \kill % set up two tab positions
%    {\bf Manipulating BGP through MD5 Cryptanalysis} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU \>~~~~~~~~~~~~~~~~~~~~~~Sep. 2016 - Dec. 2016\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%   As part of a research group advised by Prof. Sharon Goldberg, exploited known
%   cryptographic vulnerabilities in the MD5 message digest algorithm to cause a subprefix hijack attack on the Border Gateway Protocol (BGP).
%
%   \begin{tabbing}
%   \hspace{3in}\=  \hspace{1.63in}\= \kill % set up two tab positions
%    {\bf Accountability of Risk Assessment Systems} \>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BU
%    \>~~~~~~~~~~~~~~~~~~~~~~~Sep. 2018 - Dec. 2018\\                       
%   \end{tabbing}\vspace{-30pt}      % suppress blank line after tabbing
%   A non-technical analysis of the accountability properties of three government-endorsed risk assessment tools:
%   Unified Passenger (a U.S. Customs and Border Protection tool designed to detect criminal or terrorist connections at
%   border crossings), the COMPAS Risk \& Needs Assessment tool for criminal sentencing, and FICO credit scores.
%   \\
%
%
%
...
%\vspace{-15pt}
   %\begin{tabbing}
   %\hspace{2in}\= \hspace{2in}\= \hspace{1.23in}\= \kill % set up two tab positions
    %{\bf Grader/Tutor/Head Grader} \>~~~~~~HMC, CS and Math Departments \>~~~~~~~~~~~~~~~Claremont, CA \> ~~~~~~~~~~~~~~~~~~~~Fall 2012 - Fall 2014\\
   %\end{tabbing}\vspace{-30pt}
    %Tutored and graded students in the following classes: Programming Languages (2014); Principles of Computer Science, Multivariable Calculus, Linear Algebra, Differential Equations (2013); Intro to Computer Science, Calculus, Probability and Statistics (2012).  Mentored students during tutoring hours, graded students' homework in each class, and managed graders for four classes (2013).
...
% \vspace{-.05in}
% \begin{tabbing}%
%    \hspace{2in}\= \hspace{2.8in}\= \kill % set up two tab positions          
%    {\bf Treasurer}  \>People Respecting Individuals' Sexualities at Mudd \> ~~~~~~~~~~~~~~~~~~~~~~~~~~Fall 2012 - Spring 2015\\
%    \end{tabbing}\vspace{-30pt}
%     Working with the presidents, manage funds for the Harvey Mudd College club PRISM (People Respecting Individuals' Sexualities at Mudd).

% \vspace{-15pt}
%    \begin{tabbing}%
%    \hspace{2in}\= \hspace{2.8in}\= \kill % set up two tab positions          
%    {\bf Game Master}  \>Several Dungeons \& Dragons campaigns \> ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~May 2010 - Present\\
%    \end{tabbing}\vspace{-30pt}
%     Responsible for creating the entire fantasy world and its interactions with the player characters in D\&D, FATE, and other tabletop RPGs.

%\vspace{-15pt}
   %\begin{tabbing}%
  % \hspace{2in}\= \hspace{3.5in}\= \kill % set up two tab positions          
 %  {\bf Associate Concert Master}  \>~~~~~~~~~Claremont Concert Orchestra \> %~~~~~~~~~~~~~~~~~~~~~~~~~Spring 2013\\
  % \end{tabbing}\vspace{-32pt}
 %   As associate concert master, led the first violin section in the orchestra.
%\vspace{-10pt}
