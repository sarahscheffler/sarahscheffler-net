...
\begin{itemize}
\item[\architecturematters]Yanzi Lin, Cheng Zhang, Madelyne Xiao, Lorrie Faith Cranor, Sarah Scheffler. \\
\emph{What Adults Will (and Won't) Do to Prove Their Age: Empirical Evidence from a Deceptive Web Experiment}. \\
USENIX Security 2026 (conditionally accepted; forthcoming). \\
