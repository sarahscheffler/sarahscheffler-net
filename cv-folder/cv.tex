...
\newcommand{\fraudethics}{[1]\xspace}
\newcommand{\eeegroup}{[2]\xspace}
\newcommand{\csamimprovements}{[3]\xspace}
\newcommand{\eeesok}{[4]\xspace}
\newcommand{\foregoneVerif}{[5]\xspace}
\newcommand{\copyrightMDL}{[6]\xspace}
\newcommand{\turboikos}{[7]\xspace}
\newcommand{\booligero}{[8]\xspace}
\newcommand{\foregoneconclusion}{[9]\xspace}
\newcommand{\privateTranslation}{[10]\xspace}
\newcommand{\AEC}{[11]\xspace}
\newcommand{\pullingblocksJIP}{[12]\xspace}
\newcommand{\devicefingerprinting}{[13]\xspace}
\newcommand{\pullingblocks}{[14]\xspace}
\newcommand{\fairsibility}{[15]\xspace}
\newcommand{\emailspam}{[16]\xspace}
...
\section{INVITED TALKS (last updated in 2023)}
\vspace{0.1in}
